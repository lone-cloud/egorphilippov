    ...
    <div className="max-w-4xl p-8 rounded-2xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
      ...
      <div className="text-xl leading-relaxed mb-4 text-gray-900 sm:leading-normal">
        ...
        <span className="gap-2 inline-flex flex-wrap">
          <span className="inline-flex items-center bg-gray-200 py-2 px-4 rounded-full text-base font-medium transition-all duration-200 hover:-translate-y-0.5 hover:bg-blue-600/20">
            ✔️ remote
          </span>{' '}
          <span className="inline-flex items-center bg-gray-200 py-2 px-4 rounded-full text-base font-medium transition-all duration-200 hover:-translate-y-0.5 hover:bg-blue-600/20">
            ✔️ contract
