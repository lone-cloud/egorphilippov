      ...
      <EntryBody>
        ...
        <ol>
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                to host your git-controlled projects and Git Bash is my favorite command line
                terminal for windows (comes with git).
              </li>
              ...
              <li>
                ...
                - I&apos;m obsessed with staying on the latest release for my app&apos;s
                dependencies and this tells me if I&apos;m not.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            technology and read about other developer&apos;s experiences. At this point I will turn
            to some good old Googling. Hacker News and Reddit searches are usually worthwhile and
            they can be easily searched from Google by appending <Italic>site:reddit.com</Italic> to
            your search query for Reddit-only results. Websites like{' '}
          ...
          <li>
            ...
            should all preferably be implemented with a single technology. My preference at this
            time is{' '}
            ...
            for mobile. This presents a highly efficient combination allowing one to re-use some
            code between different code bases (since they&apos;re both built with React), especially
            if using a common UI library like{' '}
          ...
          <li>
            ...
            should first consider if it&apos;s even worth maintaining. Have you found a product
            market fit already and have some degree of confidence that your product will be around
            for years to come? If not, you would very likely be wasting time writing tests and
            worrying about long-term maintenance. Time that could be better spent on improving the
            product.
          </li>
        </ol>
      </EntryBody>
