...
function Post(): JSX.Element {
  return (
    <BlogEntry id={meta.id}>
      ...
      <EntryBody>
        My faithful Pixel 3 has lasted me for 3 years of heavy use, but it&apos;s finally come time
        to put it to rest and so came the time to pick out a new daily driver. In my opinion, phones
        should be compact and I am absolutely not a fan of the fact that all the modern Android
        flagships are at least 6.2&quot; in screen size. Year over year there is a very real push to
        create faster, higher spec phones and the simplest way to do that is to simply create larger
        phones so that they can hold higher performing components. As such, this time I chose to go
        with my very first iPhone. Mind you, this is not my first Apple device. In particular,
        I&apos;m a big fan of AirPods and I actually rocked the very first iTouch back in the day.
        This time I went with a (product)red iPhone mini and it&apos;s been fun getting used to a
        new phone operating system. I consider myself an advanced user and I&apos;ve now spent a ton
        of time tinkering and playing around with my new phone. Here is my comparison of the pros
        and cons of Android vs iOS.
        <Spacer />
        iOS Pros:
        <ul>
        ...
        <ul>
          ...
          <li>
            ...
            screen to animate the wallpaper? wwwhhhyyy????)
          </li>
        ...
        re-entering the passcode and it&apos;s starting to feel better now. I&apos;ve decided to be
        be sticking with my new iPhone mini for the foreseeable future.
      </EntryBody>
    </BlogEntry>
  );
}
